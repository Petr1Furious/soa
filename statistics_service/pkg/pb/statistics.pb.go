...
func (x *PostStatsRequest) GetPostId() int64 {
	if x != nil {
		return x.PostId
	}
	return 0
...
func (x *PostStatsResponse) GetViewCount() int64 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
func (x *PostStatsResponse) GetLikeCount() int64 {
	if x != nil {
		return x.LikeCount
	}
	return 0
...
type Post struct {
	...
	Count    int64 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"` // views or likes
}
...
func (x *User) GetLikesCount() int64 {
	if x != nil {
		return x.LikesCount
	}
	return 0
